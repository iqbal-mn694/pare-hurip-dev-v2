        ...
        <hr className="my-6 border-gray-200 dark:border-slate-800 sm:mx-auto lg:my-8" />
          <div className="w-full h-auto px-4 py-6 lg:pt-8">
              <div className="flex flex-wrap justify-center sm:flex sm:justify-between">
                ...
                <div className="grid grid-cols-2 gap-8 text-center sm:text-left sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-900 dark:text-slate-100 uppercase">Our Service</h2>
                    ...
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-900 dark:text-slate-100 uppercase ">Social Media</h2>
                        <ul className="text-gray-500 dark:text-slate-400 font-medium">
                            <li className="mb-4">
                    ...
                    <div>
                        <h2 className="mb-6 text-sm font-semibold text-gray-900 dark:text-slate-100 uppercase ">Legal</h2>
                        <ul className="text-gray-500 dark:text-slate-400 font-medium">
                            <li className="mb-4">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
                <span className="block text-center text-sm text-gray-500 dark:text-slate-400 sm:text-center" suppressHydrationWarning> © {new Date().getFullYear()}{" "}
